                ...
                mFriendDatabase.child(user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mfriendReqReference.child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            @Override
                            public void onCancelled(DatabaseError databaseError) {
                                Toast.makeText(Profile.this, "Error fetching Friend request data", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        mProfileSendReqButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUserId.equals(user_id)){
                    Toast.makeText(Profile.this, "Cannot send request to your own", Toast.LENGTH_SHORT).show();
                    return ;
                }
                    ...
                    mRootReference.updateChildren(requestMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError==null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(Profile.this, "Some error in sending friend Request", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(Profile.this, "Friend Request Cancelled Successfully...", Toast.LENGTH_SHORT).show();
                            }
                            else{

                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(Profile.this, "Cannot cancel friend request...", Toast.LENGTH_SHORT).show();
                    ...
                    mRootReference.updateChildren(friendMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            ...
                            if(databaseError==null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(Profile.this, "Error is " +databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setText("Send Friend Request");
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(Profile.this, "Successfully Unfriended...", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(Profile.this, "Cannot Unfriend..Contact Kshitiz..", Toast.LENGTH_SHORT).show();
                ...
                mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if(databaseError == null){
                            ...
                            mProfileSendReqButton.setText("Send Friend Request");
                            mProfileSendReqButton.setEnabled(true);
                            Toast.makeText(Profile.this, "Friend Request Declined Successfully...", Toast.LENGTH_SHORT).show();
                            ...
                            mProfileSendReqButton.setEnabled(true);
                            Toast.makeText(Profile.this, "Cannot decline friend request...", Toast.LENGTH_SHORT).show();
