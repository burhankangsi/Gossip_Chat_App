...
public class SingleItemModelFragOngoing {
    private String prodName_frg_ongoing;
    ...
    private String prod_price_frag_ongoing;
    private int prod_img_frag_ongoing;

    public SingleItemModelFragOngoing(String prodName_fo, int prod_img_fo, String prod_price_fo)
    {
